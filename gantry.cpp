...
void GANTRY::putMarkerBack(int position) {
  ...
  tool_change.write(TOOL_RETRACT);
  delay(200);
} // putMarkerBack()
...
void GANTRY::init() {
  ...
  /* FOR ESP32 PINOUT */
  z_axis.attach(48);       // attach z_axis servo to pin 47 (PWM1)
  gripper.attach(47);      // attach gripper servo to pin 48 (PWM2)
