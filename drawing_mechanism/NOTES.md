...
* resetPos() - resets robot's position
* move() - move robot to absolute position on gantry
...
* liftMarker() - rotates z-axis servo down and lowers marker (use when wanting to draw)
* lowerMarker() - rotates z-axis servo up and raises marker (use when done drawing)
* switchMarker() - 
