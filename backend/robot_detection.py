...
class Aruco:
    ...
    def find_pos(robot_tag, board_tags):
        ...
        global_positions = {
            ...
            BOARD_IDS[1]: [0, self.height_mm],        # Bottom-left corner 
            BOARD_IDS[2]: [self.width_mm, 0],         # Top-right corner
            BOARD_IDS[3]: [self.width_mm, self.height_mm]  # Bottom-right corner
        }
