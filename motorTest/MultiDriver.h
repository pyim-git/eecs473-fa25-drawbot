...
public:
    ...
    {};
    /*
     * Four-motor setup (W, X, Y, Z for example)
     */
    MultiDriver(Motor& motor1, Motor& motor2, Motor& motor3, Motor& motor4)
    :MultiDriver(MAX_MOTORS, new Motor* const[MAX_MOTORS]{&motor1, &motor2, &motor3, &motor4})
    {};
     ...
     */
    void begin(float rpm=200, short microsteps=1);
    /*
     * Move the motors a given number of steps.
     * positive to move forward, negative to reverse
     */
    void move(long steps1, long steps2, long steps3, long steps4);
    void rotate(int deg1, int deg2, int deg3, int deg4){
        rotate((long)deg1, (long)deg2, (long)deg3, (long)deg4);
    };
    void rotate(long deg1, long deg2, long deg3, long deg4);
    void rotate(double deg1, double deg2, double deg3, double deg4);

    /*
     * Motor movement with external control of timing
     */
    virtual void startMove(long steps1, long steps2, long steps3, long steps4);
    void startRotate(int deg1, int deg2, int deg3, int deg4){
        startRotate((long)deg1, (long)deg2, (long)deg3, (long)deg4);
    };
    void startRotate(long deg1, long deg2, long deg3, long deg4);
    void startRotate(double deg1, double deg2, double deg3, double deg4);
    /*
